export const COMPOUND = {
  ...
  sepoliaWETH: {
    address: "0xaD0C044425D81a2E223f4CE699156900fead2Aaa",
    abi: [
      {
        inputs: [
      ...
      { inputs: [], name: "UnsupportedBaseAsset", type: "error" },
      {
        anonymous: false,
        inputs: [
          {
...
export const SupplyAssetsCompound = [
  {
    id: 1,
    name: "USDC",
    symbol: "USDC",
...
export const BorrowAssetsCompound = [
  {
    id: 1,
    name: "USDT",
    symbol: "USDT",
...
export const SuppliedAssetsCompound = [];
export const BorrowedAssetsCompound = [];
